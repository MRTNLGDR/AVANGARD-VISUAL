...
- `docs/screenshots/02-agent-director.png`
- `docs/screenshots/03-agent-workflow.png`
- `docs/screenshots/04-preflight-blocked.png`
- `docs/screenshots/05-providers.png`
- `docs/screenshots/06-governance.png`
- `docs/screenshots/07-responsive-1024.png`
...
```text
avangard_cinenode_studio-0.2.0-py3-none-any.whl
size: 1545941 bytes
