...
function topbarHtml() {
  ...
  return `
    <div class="brand"><span class="brand-mark"></span><span class="brand-copy"><strong>CineNode Studio</strong><span>Avangard · v${escapeHtml(state.bootstrap?.app?.version || "0.2.0")}</span></span></div>
...
function agentHtml() {
  ...
  return `<section class="page agent-page">
    ...
    <form id="agent-form" class="agent-layout">
      <article class="card"><div class="card-header"><h2>1 · Brief e entrega</h2><span class="badge READY">AGENTE REAL</span></div><div class="card-body agent-form-grid">
